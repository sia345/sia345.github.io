export class Sentence
{
	...
	known_mines()
	{
		...
		return new Set();//Возвращает ячейки, о которых известно, что они мины.
	...
	mark_safe(cell)
	{
		...
		this.cells.delete(cell)//Обновляет внутреннее представление знаний,
	...
	mark_mine(cell)
	{
		if(this.cells.has(cell))
		{
			...
			--this.count;
		}//Обновляeт внутреннее представление знаний,
